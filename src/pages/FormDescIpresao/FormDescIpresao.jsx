    ...
    return (
        <>
            <div className="relatoriooImprimir">
                <Link to="/Relatorio"><img className="voltarIM" src={Logo} alt="voltar" /></Link>
                <button className="imprimir" onClick={() => { handlePrint(null, () => contentToPrint.current); }}>IMPRIMIR</button>

                <div ref={contentToPrint}>
                    <p className="pPaciente">Pacientes:</p><hr />  <img className="IMpresaofot" src={Logo2} alt="voltar" />
