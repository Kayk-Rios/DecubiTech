      ...
      <Link to="/PreHome"> <img className="image2" src={imagem3} alt="Voltar" title="Voltar" /></Link>
       ...
       <form className="formPaciente pesquisar" >
        <div className="pesquisaPaciente">
          <input type="search" className="PriMeiroinput" placeholder="Pesquisar" />
          <button className="ButoaLupa " disabled>  <img className="lupa1" src={Lupa} alt="Voltar" title="pesquisar" /></button>
                     ...
                     <div className="h2paciciente">
                        ...
                        <div className="detalhes">
                              <details>
                                    ...
                                    <summary className="Descbutton">Descriçao do Pacientes</summary>
                                                  <p className="cpf">CPF</p>
                                                {usuario.cpf} <br />
                                                <p className="Descricao">Descriçao</p>
                                                {usuario.Descricao} 
                                                <br />
                                              <button onClick={() => removeUsuario(usuario.userId)} className="butaoExcuir">Excluir</button>
